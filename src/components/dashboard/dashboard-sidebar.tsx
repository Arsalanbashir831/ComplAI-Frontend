...
const COMPLIANCE_TOOLS = [
    { href: ROUTES.CHAT, icon: Bot, label: "Compliance GPT" },
    { href: "/doc-compliance", icon: FileText, label: "Doc Compliance" },
]
...
export function DashboardSidebar() {
    ...
    const renderSectionHeader = (title: string) => (
        <div className="px-4 py-2 text-xs text-gray-400 uppercase tracking-wider">{title}</div>
    )
