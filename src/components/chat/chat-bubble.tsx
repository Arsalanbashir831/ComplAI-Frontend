...
}: ChatBubbleProps)
{
    ...
    return (
        <div className={cn('flex mb-3', isBot ? 'justify-start' : 'justify-end')}>
            <div
                className={cn(
                    `flex flex-col gap-2 rounded-2xl py-2 items-center justify-center ${isBot ? 'px-0' : 'px-4 md:px-8 '
                    } md:max-w-[66.666667%]`,
                    isBot
                        ? 'bg-white'
                        ...
                        <div className="flex gap-2">
                            ...
                            {isError && onRetry && (
                                <Button
                                    onClick={onRetry}
                                    disabled={isRetrying}
                                    className="text-xs px-3 h-fit py-1 rounded-full text-white flex items-center gap-2"
                                >
                                    {isRetrying ? (
