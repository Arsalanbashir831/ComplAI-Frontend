        ...
        <div className="w-full p-6">
            ...
            <div className="mt-8 bg-white rounded-xl p-6 shadow-sm">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <Link href="/doc-compliance/ai-editor">
                ...
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="bg-[#07378C] text-white text-xs rounded-full p-2 px-3">{issues.length}</span>
                </div>
                        ...
                        {issues.map((issue) => (
                            <div key={issue.id} className="py-4 border-b last:border-b-0">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p className="font-medium text-sm text-gray-500">{issue.type}</p>
