...
export default function DocCompliancePage() {
  ...
  const handleAIReview = async () => {
    ...
    try {
      ...
      //   {
      //     original:
      //       'Our Services Gerry’s Solicitors Ltd. offers legal services in the following areas: [Insert your practice areas, e.g., Family Law, Conveyancing, Employment Law, Commercial Law, etc.]',
      //     compliant: false,
      //     suggestion:
      //       'Our Services Gerry’s Solicitors Ltd. offers legal services in the following areas: Family Law, Conveyancing, Employment Law, Commercial Law.',
      //     reason:
      ...
      //   {
      //     original:
      //       'If unresolved, contact our Complaints Officer at [complaints@gerrysolicitors.co.uk] or by.',
      //     compliant: false,
      //     suggestion:
      //       'If unresolved, contact our Complaints Officer at [complaints@gerrysolicitors.co.uk] or by phone at [insert phone number].',
      //     reason:
      //       'The sentence is incomplete and does not provide a complete method of contact.',
      //     citations: [],
      //   },
      //   {
      //     original:
      ...
      //     compliant: false,
      //     suggestion:
      //       'If you remain dissatisfied, you may refer the matter to the Legal Ombudsman at: Website: www.legalombudsman.org.uk Phone: 0300 555 0333 Email: enquiries@legalombudsman.org.uk Address: PO Box 6806, Wolverhampton, WV1 9WJ You must contact the Legal Ombudsman within six months of receiving a final response from us.',
      //     reason:
      //       'The address for the Legal Ombudsman is incorrect, and the time limit for contacting them is missing.',
      //     citations: ['https://www.legalombudsman.org.uk/information-centre/'],
      //   },
      //   {
      //     original:
      ...
      //     reason:
      //       "The phrase 'breakdown in trust' is vague and may not meet the requirement for clear and precise terms in contracts.",
      //     citations: [
      //       'https://www.sra.org.uk/solicitors/standards-regulations/code-conduct-solicitors/',
      //     ],
      //   },
