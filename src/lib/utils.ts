...
export function getAuthorityOptionColor(authority: AuthorityValue): string {
  switch (authority) {
    case 'SRA':
      return 'hover:!bg-yellow-50 focus:!bg-yellow-50 focus:!text-yellow-700 data-[state=checked]:!bg-yellow-100 data-[state=checked]:!text-yellow-700';
    case 'LAA':
      return 'hover:!bg-green-50 focus:!bg-green-50 focus:!text-green-700 data-[state=checked]:!bg-green-100 data-[state=checked]:!text-green-700';
    case 'AML':
      return 'hover:!bg-cyan-50 focus:!bg-cyan-50 focus:!text-cyan-700 data-[state=checked]:!bg-cyan-100 data-[state=checked]:!text-cyan-700';
    default:
